...
webdriverDir = 'driver/chrome/chromedriver-mac-arm64' # 使用浏览器驱动
home_url = 'https://appleid.apple.com/us/account/'
captcha_url = 'https://appleid.apple.com/us/captcha' # 获取验证码
...
def create_apple(body={}):
	...
	browser.find_element_by_class_name("confirm-field").send_keys(body['password'])
...
if __name__ == "__main__":
	...
	body = {
			'email':'ucyomw@mailnesia.com',
			'emailPassword': '0734', 	# 邮箱登录密码

			'password':'DJPdjp182!',		# 注册密码
			'last_name':'dt',
			'first_name':'dtl',
			'birthday_field':'1990-11-22',
			'answer1':'问题答案1',
